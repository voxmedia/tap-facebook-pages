...
from tap_facebook_pages.streams import (
    ...
    VideoStream,
    AllVideosStream,
    VideoInsightsLifetimeStream,
    VideoInsightsDailyStream,
)
...
class TapFacebookPages(Tap):
    ...
    config_jsonschema = th.PropertiesList(
        ...
        th.Property(
            "videos_table_name",
            th.StringType,
            description="The table name used to fetch video IDs from in the form of project.schema.table_name",
        ),
        th.Property(
            "video_id_field",
            th.StringType,
